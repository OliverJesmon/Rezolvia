  ...
  return (
    <div>
      ...
      <div className="absolute inset-0 z-0">
        ...
        />
        {/* <div className="w-full h-full object-cover bg-linear-to-t from-sky-500 to-indigo-500"/> */}
      </div>
      <div className="relative z-10 px-6 " >
        ...
        {/* <div className="max-w-md mx-auto">
          <h2 className="text-xl font-medium mb-4">Build with Us</h2>
          <p className="text-sm opacity-80 mb-8">
            Welcome to Elyse Residence, where timeless design, wellness-focused living, and cultural enrichment converge...
          </p>
