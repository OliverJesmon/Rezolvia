...
const Footer = () => {
  return (
        ...
        <div className="mx-auto px-6 text-center md:flex-col md:justify-between">
            <div className="text-2xl text-white font-bold md:absolute md:left-15 mb-4"><img src={Logo} alt="Logo" className="h-12 md:m-4 mx-15" oncontextmenu="return false;"/></div>
